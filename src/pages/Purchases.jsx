      ...
      {purchases.map((purchase) => (
        <div key={purchase.id} className="purchase-container rounded mb-4">
          ...
          {purchase.cart.products.map((product) => (
            ...
            >
              <p className="m-0" style={{ width: '22rem' }}>
                {product.title}
              </p>
              <p className="purchases-quantity-container m-0 d-flex justify-content-center align-items-center">
                {product.productsInCart.quantity}
              </p>
              <p className="fw-bold m-0 text-end" style={{ width: '5.5rem' }}>
