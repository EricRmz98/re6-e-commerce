    ...
    if (Object.keys(productDetails || {}).length !== 0) {
      setSuggestedProducts(
        allProducts
          .filter(
            (product) =>
              productDetails.category.id === product.category.id &&
  ...
  return (
    <div className="details-father">
      <div className="details-header">
        <a
          className="m-0 ms-1 mb-4 product-anchor"
          onClick={() => navigate('/')}
        >
          <small>Home </small>
      ...
      <div className="px-1 details-container d-flex">
          ...
          <div className="d-flex justify-content-between align-items-center mb-1">
            ...
            <div className="gallery-img-container">
              <img
                ...
                src={productDetails?.productImgs?.[imageIndex]}
              />
            </div>
        ...
        <div className="product-info-container ps-3 d-flex flex-column justify-content-between">
          ...
          <div className="d-grid gap-2 mb-1">
            <Button variant="primary" size="md" onClick={addToCart}>
      ...
      <div className="suggestions-container">
        <p className="text-primary fw-bold px-1 my-3 suggestions-header">
          <small>Similar products</small>
        </p>
